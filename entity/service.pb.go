...
var file_service_proto_goTypes = []interface{}{
	...
	(*JobDeleteRequest)(nil),        // 22: service.JobDeleteRequest
	(*JobDeleteReply)(nil),          // 23: service.JobDeleteReply
	(*JobNextRequest)(nil),          // 24: service.JobNextRequest
	(*JobNextReply)(nil),            // 25: service.JobNextReply
	(*JobDisplayRequest)(nil),       // 26: service.JobDisplayRequest
	(*JobDisplayReply)(nil),         // 27: service.JobDisplayReply
	(*JobGetLogRequest)(nil),        // 28: service.JobGetLogRequest
	(*JobGetLogReply)(nil),          // 29: service.JobGetLogReply
	(*SourceListRequest)(nil),       // 30: service.SourceListRequest
	(*SourceListReply)(nil),         // 31: service.SourceListReply
	(*DeviceListRequest)(nil),       // 32: service.DeviceListRequest
	(*DeviceListReply)(nil),         // 33: service.DeviceListReply
	(*LibraryExportRequest)(nil),    // 34: service.LibraryExportRequest
	(*LibraryExportReply)(nil),      // 35: service.LibraryExportReply
	(*LibraryTrimRequest)(nil),      // 36: service.LibraryTrimRequest
	(*LibraryTrimReply)(nil),        // 37: service.LibraryTrimReply
	(*File)(nil),                    // 38: file.File
	(*Position)(nil),                // 39: position.Position
	(*EditedFile)(nil),              // 40: file.EditedFile
...
var file_service_proto_depIdxs = []int32{
	...
	39, // 1: service.FileGetReply.positions:type_name -> position.Position
	38, // 2: service.FileGetReply.children:type_name -> file.File
	40, // 3: service.FileEditRequest.file:type_name -> file.EditedFile
	38, // 4: service.FileEditReply.file:type_name -> file.File
	38, // 5: service.FileMkdirReply.file:type_name -> file.File
	38, // 6: service.FileListParentsReply.parents:type_name -> file.File
	11, // 7: service.TapeListRequest.mget:type_name -> service.TapeMGetRequest
	41, // 8: service.TapeListRequest.list:type_name -> tape.TapeFilter
	42, // 9: service.TapeListReply.tapes:type_name -> tape.Tape
